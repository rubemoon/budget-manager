...
export default function AboutMe() {
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        <span className="font-bold">Hello, I'm Rubens.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">ROR</span>.
      </motion.h1>
      ...
      >
        <a
          href="https://blog.kozenetpro.com"
          target="_blank"
        ...
        <a
          ...
          href="/Rubens Jean Simon 2024.pdf"
          download
        >
          Download my CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/rubens-jean-simon/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <BsLinkedin />
        ...
        <a
          ...
          href="https://github.com/rubemoon"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaGithubSquare />
